...
## Reset về layout Sidebar mặc định: bỏ đoạn CSS tùy biến

# Hiển thị logo (nếu có)
try:
    col1, col2, col3 = st.columns([3, 2, 3])
    with col2:
        st.image("phong.jpg", use_container_width=True)
except:
    pass
...
# Lấy OpenAI API key
openai_api_key = "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"
